function HomeFeature() {
  return (
    <div className="w-full py-6 px-[20px] lg:px-[0px]">
      <div className="flex justify-center py-6 overflow-hidden border lg:mx-auto lg:container">
        <div className="flex w-full justify-around">
          <div>
            <div className="service__sliderSingle flex gap-3">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth={0}
                viewBox="0 0 1024 1024"
                className="text-[34px] text-cyan-700 text-thin"
                height="1em"
                width="1em"
              ...
              <div className="flex flex-col">
                <span className="text-[14px] font-bold">Secure Payment</span>
          ...
          <div>
            <div className="service__sliderSingle flex gap-3">
              <svg
                ...
                strokeWidth={0}
                viewBox="0 0 32 32"
                className="text-[38px] text-cyan-700 text-thin"
                height="1em"
                width="1em"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div>
            <div className="service__sliderSingle flex gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-[14px] font-bold">Customer Support</span>
                <span className="text-[13px] text-gray-600">
